...
<body class="page-index">
  ...
  <!-- ======= Hero Section ======= -->
  <section id="hero" class="hero d-flex align-items-center bg-image"style="background-image: url('/img/nanda222.jpg');">
    <div class="container">
      <div class="row">
        <div class="col-xl-4">
          <h2 data-aos="fade-up">SELAMAT DATANG DI TUGAS PEMOGRAMAN INTERNET SAYA</h2>
          <blockquote data-aos="fade-up" data-aos-delay="100">
            <p>Nama: I Kadek Nanda Surya Agusta</p>
            <p>NIM: 2205551022</p>
            <p>Kelas: A</p>
